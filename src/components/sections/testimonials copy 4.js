    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        >
          ...
          {/* lg:after:border-t-0 */}
          <div className="flex flex-col after:block after:border-t-[1px] after:border-black lg:after:border-l-[1px]  lg:pl-8 py-10 lg:pb-10 lg:pt-0 xl:pl-20">
          ...
          {/* testimonial 3 */}
          {/* pb-10 sm:pb-16 */}
          <div className="flex flex-col py-10 lg:pb-0 lg:pr-8 xl:pr-20 after:block after:border-t-[1px] after:border-black lg:after:border-l-0 lg:after:border-t-[1px]">
            <div className="relative h-12 w-[105px] self-start">
              <Image
                alt=""
                src="https://tailwindui.com/img/logos/tuple-logo-gray-900.svg"
          ...
          {/* testimonial 4 */}
          {/* sm:pt-16 lg:pt-0 */}
          <div className="flex flex-col after:content-[''] after:block after:border-t-[1px] after:border-black lg:after:border-l-[1px] lg:after:border-t-[1px] pt-10 lg:pl-8 xl:pl-20">
            <div className="relative h-12 w-[104px] self-start">
              <Image
                alt=""
                fill
