...
const testimonials = () => {
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-lg md:max-w-[44rem] lg:max-w-[44rem] text-center">
      ...
      <div className="mx-auto max-w-7xl px-6 dit">
        <div className="mx-auto grid max-w-2xl grid-cols-1 cys dcy ded">
          <div className="flex flex-col pb-10 sm:pb-16 dji dkm dsu">
          ...
          {/* border-[rgb(17_24_39_/_0.1)] */}
          <div className="flex flex-col border-t-[1px] border-black pt-10 sm:pt-16 dhj dhm dkf dko dsj">
